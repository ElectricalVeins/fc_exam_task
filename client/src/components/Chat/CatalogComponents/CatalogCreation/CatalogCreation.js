...
class CatalogCreation extends React.Component {
  ...
  render() {
    ...
    const addStyles = classNames({
      [styles.active]:
        catalogCreationMode === CONSTANTS.ADD_CHAT_TO_OLD_CATALOG,
    })
    const creationStyles = classNames({
      [styles.active]:
        ...
        {!isFetching && (
          <div className={styles.catalogCreationContainer}>
            ...
            <div className={styles.buttonsContainer}>
              <span
                onClick={() =>
                  changeTypeOfChatAdding(CONSTANTS.ADD_CHAT_TO_OLD_CATALOG)
                }
                className={addStyles}
              >
                Old
              ...
              <span
                onClick={() =>
                  changeTypeOfChatAdding(
                    CONSTANTS.CREATE_NEW_CATALOG_AND_ADD_CHAT
                  )
                }
                className={creationStyles}
              >
                New
              </span>
            </div>
